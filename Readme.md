<!-- default badges list -->
![](https://img.shields.io/endpoint?url=https://codecentral.devexpress.com/api/v1/VersionRange/128629757/24.2.1%2B)
...
![WinForms Data Grid - Scroll by columns](media/winforms-grid-scroll-by-column.gif)
